...
class PolynomialImportanceMinimalityLossConfig(LossMetricConfig):
    classname: Literal["PolynomialImportanceMinimalityLoss"] = (
...
class BetaInfPolynomialImportanceMinimalityLossConfig(LossMetricConfig):
    classname: Literal["BetaInfPolynomialImportanceMinimalityLoss"] = (
