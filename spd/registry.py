...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    ...
    "pingpong_ideal_init_64-8": ExperimentConfig(
        task_name="pingpong",
        decomp_script=Path("spd/experiments/tms/pingpong_ideal_init_decomposition.py"),
        config_path=Path("spd/experiments/tms/pingpong_ideal_init_64-8_config.yaml"),
        expected_runtime=60,
        canonical_run=None,
    ),
    "pingpong_percircuit_ideal_init_64-8": ExperimentConfig(
        task_name="pingpong",
        decomp_script=Path("spd/experiments/tms/pingpong_percircuit_ideal_init_decomposition.py"),
        config_path=Path("spd/experiments/tms/pingpong_percircuit_ideal_init_64-8_config.yaml"),
        expected_runtime=60,
        canonical_run=None,
    ),
    "pingpong_vectormlp_ideal_init_64-8": ExperimentConfig(
        task_name="pingpong",
        decomp_script=Path("spd/experiments/tms/pingpong_vectormlp_ideal_init_decomposition.py"),
        config_path=Path("spd/experiments/tms/pingpong_vectormlp_ideal_init_64-8_config.yaml"),
        expected_runtime=60,
        canonical_run=None,
    ),
    ...
    "pingpong_probe_64-8": ExperimentConfig(
        task_name="pingpong",
        decomp_script=Path("spd/experiments/tms/pingpong_percircuit_ideal_init_decomposition.py"),
        config_path=Path("spd/experiments/tms/pingpong_probe_64-8_config.yaml"),
        expected_runtime=20,
        canonical_run=None,
    ),
